...
namespace WarGame {
		...
		uint DemoGame::play() {
			...
			board.move(2, {7,3}, Board::MoveDIR::Down);    // FootSoldier of player 2 moves   and attacks.
		...
		board.print();
			...
			board.move(2, {7,5}, Board::MoveDIR::Down);    // FootCommander of player 2 moves left, and all soldiers of play2 attack.
			if (!board.has_soldiers(1)) return 2;
			board.print();
